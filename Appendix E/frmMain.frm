   ...
   Begin TabDlg.SSTab tabData 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Image imgNotes 
            ...
            ToolTipText     =   "Display System Notes"
            Top             =   1632
            Width           =   384
         End
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":0ACC
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain.frx":0BDE
            Key             =   "Help"
         EndProperty
      EndProperty
   End
...
'Declare objects
Dim objData As htDataAccess.clsSelectData
Dim objInsert As htDataAccess.clsInsertData
Dim objUpdate As htDataAccess.clsUpdateData
Dim objDelete As htDataAccess.clsDeleteData
Dim objRSData As ADODB.Recordset

'Declare variables
Dim arrSerialNumber() As String
Dim lngLocationID As Long
Dim lngSystemAssignmentID As Long
...
Private Sub cboEmployee_Click()
   ...
   If Not g_objRS.EOF Then
      ...
      'Save the system assignment id
      lngSystemAssignmentID = g_objRS!System_Assignment_ID
   End If
...
Private Sub cboLocation_Click()
   ...
   'Save the location id for the location selected
   lngLocationID = cboLocation.ItemData(cboLocation.ListIndex)
End Sub
...
Private Sub cmdDelete_Click()
   ...
   'Display status
   StatusBar1.Panels("pnlStatus").Text = "Processing Delete"
   
   'Declare local variables
   Dim lngRC As Long, strMessage As String

   'Set a reference to the Delete data class
   Set objDelete = New clsDeleteData
   ...
   Select Case tabData.Tab
      ...
      Case 0  'Employee
         ...
         'Delete the employee
         lngRC = objDelete.DeleteEmployee(g_objConn, _
            objRSData!Employee_ID, _
            strMessage)
         
         'Ensure we were successful
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdDelete_Click", _
               "Call to DeleteEmployee failed"
         End If
         ...
         'to reflect the deleted employee
         Call tabData_Click(0)
      
      Case 1  'Hardware
      
         'Delete the hardware
         lngRC = objDelete.DeleteHardware(g_objConn, _
            objRSData!Hardware_ID, _
            strMessage)
         
         'Ensure we were successful
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdDelete_Click", _
               "Call to DeleteHardware failed"
         End If
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the deleted hardware
         Call tabData_Click(1)
      
      Case 2  'Software
      
         'Delete the software
         lngRC = objDelete.DeleteSoftware(g_objConn, _
            objRSData!Software_ID, _
            strMessage)
         
         'Ensure we were successful
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdDelete_Click", _
               "Call to DeleteSoftware failed"
         End If
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the deleted software
         Call tabData_Click(2)
      
      Case 3  'System Assignment
      
         'Delete the system assignment and software
         lngRC = objDelete.DeleteSystemAssignment(g_objConn, _
            lngSystemAssignmentID, _
            strMessage)
         
         'Ensure we were successful
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdDelete_Click", _
               "Call to DeleteSystemAssignment failed"
         End If
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the deleted system assignment
...
Private Sub cmdUpdate_Click()
   ...
   'Display status
   StatusBar1.Panels("pnlStatus").Text = "Processing Update"
   ...
   'Set a reference to the update data class
   Set objUpdate = New clsUpdateData
   ...
   Select Case tabData.Tab
      ...
      Case 0  'Employee
         ...
         'Update the employee
         lngRC = objUpdate.UpdateEmployee(g_objConn, _
            objRSData!Employee_ID, _
            txtFirstName.Text, _
            cboLastName.Text, _
            txtPhoneNumber.Text, _
         ...
         'Ensure we were successful
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdUpdate_Click", _
               "Call to UpdateEmployee failed"
         End If
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the employee updates
         Call tabData_Click(0)
      
      Case 1  'Hardware
      
         'Update the hardware
         lngRC = objUpdate.UpdateHardware(g_objConn, _
            objRSData!Hardware_ID, _
            cboManufacturer.Text, _
            txtModel.Text, _
            txtProcessorSpeed.Text, _
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the hardware update
         Call tabData_Click(1)
      
      Case 2  'Software
      
         'Update the software
         lngRC = objUpdate.UpdateSoftware(g_objConn, _
            objRSData!Software_ID, _
            cboSoftware.Text, _
            cboSoftwareCategory.ItemData(cboSoftwareCategory.ListIndex), _
            strMessage)
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the software update
         Call tabData_Click(2)
      ...
      Case 3  'System Assignment
         ...
         'Update the system assignment and software
         lngRC = objUpdate.UpdateSystemAssignment(g_objConn, _
            lngSystemAssignmentID, _
            cboEmployee.ItemData(cboEmployee.ListIndex), _
            cboSystem.ItemData(cboSystem.ListIndex), _
            lngInstalledSoftware(), _
         ...
         If lngRC <> 0 Then
            Err.Raise 513 + vbObjectError, "cmdUpdate_Click", _
               "Call to UpdateSystemAssignment failed"
         End If
         ...
         'ReInitialize the tab control so the opened RS is reloaded
         'to reflect the system assignment update
         Call tabData_Click(3)
...
Private Sub Form_Unload(Cancel As Integer)
   ...
   'Just in case, remove the notes form
   Unload frmNotes
...
Private Sub imgNotes_DblClick()
   'Display Notes form
   frmNotes.DisplayNotes cboSystem.ItemData(cboSystem.ListIndex), _
      cboSystem.Text
End Sub
...
Private Sub mnuToolsOnlineReports_Click()
   'Invoke a browser with the following URL
   ShellExecute Me.hwnd, "open", _
      "http://wstravel/hardwaretracking/default.htm", _
...
Private Sub Timer1_Timer()
   ...
   If TypeOf Me.ActiveControl Is TextBox Or _
      ...
      'See if there's anything to cut
      Me.mnuEditCut.Enabled = Me.ActiveControl.SelLength
      Me.Toolbar1.Buttons("btnCut").Enabled = Me.ActiveControl.SelLength
      
      'See if there's anything to copy
      Me.mnuEditCopy.Enabled = Me.ActiveControl.SelLength
      Me.Toolbar1.Buttons("btnCopy").Enabled = Me.ActiveControl.SelLength
      
      'See if there's anything to paste
      Me.mnuEditPaste = Clipboard.GetFormat(vbCFText)
      Me.Toolbar1.Buttons("btnPaste").Enabled = Clipboard.GetFormat(vbCFText)
   End If
